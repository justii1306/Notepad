...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        nowyAction.setShortcut(QKeySequence('Ctrl+S'))
        nowyAction.triggered.connect(self.zapiszFun)

        zapiszJakoAction = QAction(QIcon('zapiszJako.png'), 'Zapisz jako', self)
        nowyAction.setShortcut(QKeySequence('Shift+Ctrl+S'))
        nowyAction.triggered.connect(self.zapiszJakoFun)
        ...
        nowyAction.setShortcut(QKeySequence('Ctrl+C'))
        nowyAction.triggered.connect(self.skopiujFun)

        wklejAction = QAction(QIcon('wklej.png'), 'Wklej', self)
        nowyAction.setShortcut(QKeySequence('Ctrl+V'))
        nowyAction.triggered.connect(self.wklejFun)
